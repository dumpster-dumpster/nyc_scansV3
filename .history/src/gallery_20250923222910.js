...
export async function renderGallery() {
    ...
    try {
        loadingManager.addTask('populate-gallery', 'Loading gallery');
        await populateGallery(galleryStrip);
        loadingManager.completeTask('populate-gallery', 'Gallery loaded');
    } catch (error) {
        console.error('Error populating gallery:', error);
        loadingManager.completeTask('populate-gallery', 'Gallery error');
